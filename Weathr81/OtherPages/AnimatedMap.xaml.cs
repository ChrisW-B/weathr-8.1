...
namespace Weathr81.OtherPages
{
    ...
    /// </summary>
    public sealed partial class AnimatedMap : Page
    {
        ...
        #endregion
        StatusBar statusBar;
       async private void setupMap(Uri uri)
        {
            statusBar = StatusBar.GetForCurrentView();
            statusBar.ProgressIndicator.Text = "Loading map...";
            ...
            else
            {
                ...
                statusBar.ProgressIndicator.Text = "Couldn't load map, try checking your connection";
            }
        }
